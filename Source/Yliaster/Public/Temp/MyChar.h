...
/*
	UPROPERTY(ViewAnywhere, BlueprintReadOnly, Category = "Grid")
	int32 minx = GetGrid Reference GetTile(0, 0)->GetComponentLocation();
		Min y = GetComponentLocation(Row(0))
		Max x = GetComponentLocation(Column(max))
		Max y = GetComponentLocation(Row(max))
*/
	UPROPERTY()
	float MovementDelta;
